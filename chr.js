function next(){
  ...
  document.getElementById("othN").innerHTML=(document.getElementsByClassName("oth1")[0].innerHTML*document.getElementById("othT").innerHTML).toFixed(2);function sendEmail() { function sendEmail() { 
...
document.getElementById("thPh").innerHTML=(document.getElementsByClassName("first")[0].innerHTML*0.19).toFixed(2);

document.getElementById("thA").innerHTML=(document.getElementsByClassName("first")[0].innerHTML*0.05).toFixed(2);

document.getElementById("thA").innerHTML=(document.getElementsByClassName("first")[0].innerHTML*0.05).toFixed(2);

document.getElementById("mtN").innerHTML=(document.getElementsByClassName("first")[1].innerHTML*0.475).toFixed(2);

document.getElementById("mtP").innerHTML=(document.getElementsByClassName("first")[1].innerHTML*0.245).toFixed(2);

document.getElementById("mtR").innerHTML=(document.getElementsByClassName("first")[1].innerHTML*0.035).toFixed(2);

document.getElementById("mtNPR").innerHTML=(document.getElementsByClassName("first")[1].innerHTML*0.755).toFixed(2);

document.getElementById("mtPh").innerHTML=(document.getElementsByClassName("first")[1].innerHTML*0.21).toFixed(2);

document.getElementById("mtA").innerHTML=(document.getElementsByClassName("first")[1].innerHTML*0.035).toFixed(2);

document.getElementById("slN").innerHTML=(document.getElementsByClassName("first")[2].innerHTML*0).toFixed(2);

document.getElementById("slP").innerHTML=(document.getElementsByClassName("first")[2].innerHTML*0.3).toFixed(2);  
...
document.getElementById("miN").innerHTML=(document.getElementsByClassName("first")[4].innerHTML*0.65).toFixed(2);

document.getElementById("miP").innerHTML=(document.getElementsByClassName("first")[4].innerHTML*0.11).toFixed(2);

document.getElementById("miR").innerHTML=(document.getElementsByClassName("first")[4].innerHTML*0.03).toFixed(2);

document.getElementById("miNPR").innerHTML=(document.getElementsByClassName("first")[4].innerHTML*0.79).toFixed(2);

document.getElementById("miPh").innerHTML=(document.getElementsByClassName("first")[4].innerHTML*0.21).toFixed(2);

document.getElementById("miA").innerHTML=(document.getElementsByClassName("first")[4].innerHTML*0).toFixed(2);

document.getElementById("plN").innerHTML=(document.getElementsByClassName("first")[5].innerHTML*0).toFixed(2);

document.getElementById("plP").innerHTML=(document.getElementsByClassName("first")[5].innerHTML*1).toFixed(2);

document.getElementById("plR").innerHTML=(document.getElementsByClassName("first")[5].innerHTML*0).toFixed(2);

document.getElementById("plNPR").innerHTML=(document.getElementsByClassName("first")[5].innerHTML*1).toFixed(2);

document.getElementById("plPh").innerHTML=(document.getElementsByClassName("first")[5].innerHTML*0).toFixed(2);

document.getElementById("plA").innerHTML=(document.getElementsByClassName("first")[5].innerHTML*0).toFixed(2);

document.getElementById("ssN").innerHTML=(document.getElementsByClassName("first")[6].innerHTML*0).toFixed(2);  

document.getElementById("ssP").innerHTML=(document.getElementsByClassName("first")[6].innerHTML*0.5).toFixed(2);
...
document.getElementById("coN").innerHTML=(document.getElementsByClassName("first")[7].innerHTML*0).toFixed(2);  

document.getElementById("coP").innerHTML=(document.getElementsByClassName("first")[7].innerHTML*0.3).toFixed(2);
...
for(i=0;i<fir;i++){
  ...
  ii+=parseInt(document.getElementsByClassName("first")[i].innerHTML, 10);

}

document.getElementsByClassName("tot")[0].innerHTML=ii;
